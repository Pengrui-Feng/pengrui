...
#input csv file,
path= '/home/zdong/'
df = pd.read_csv(path + "combined_td_gps_.csv")#,usecols=['PTT','argos_date','argos_time','lat_argos','lon_argos']
...
dalta_date.rename(index={'PTT':'ptt', '0':'dalta'}, inplace = True)
#lat
...
c.insert(7,'dalta_lat',dalta_lat)
c.insert(8,'dalta_lon',dalta_lon)
